...
=== Bar ===
    ...
    * (EnterWhileOpen) [Enter now { loop == 1 : (+ 10 / + 35) }]
    ...
    -> EnteringTheBar
    * (EnterWhileClosed) [Wait for the bar to close { loop == 1 : (- 5 / + 25) }]
    { loop == 1: This is not the best option. Try again. -> TopBar }
    ...
    * [Take a seat at the bar]
        ...
        * * [Introduce yourself]
            ...
            * * * [I am quite sure you have]
                ...
                - - - - (Explanations)
                * * * * [Explain the timesaving bank { loop == 1 : (- 5 / + 40) }]
                ~ stolen_time = stolen_time - 5
                    -> ExplainTimesavingBank
                * * * * [Show how much time Nino wastes { loop == 1 : (+ 5 / + 15) }]
                { loop == 1: This is not the best option. Try again. -> Explanations }
                ~ stolen_time = stolen_time + 5
                -> HowMuchTimeIsWasted
                - - - -
                -> END              
...
= ExplainTimesavingBank
    ...
    - (TopExplainTimesavingBank)
    * [Let him finish his question { loop == 1 : (- 5 / + 35) }]
        { loop == 1: This is not the best option. Try again. -> TopExplainTimesavingBank }
        ...
        ~ stolen_time = stolen_time - 5
    * [Interrupt him { loop == 1 : (+ 5 / + 35) }]
        ~ stolen_time = stolen_time + 5
    - (TopDetails)
        * * [Do not worry about the details { loop == 1 : (+ 0 / + 35) }]
            ...
            ~ stolen_time = stolen_time + 0
            -> DontWorry
        * * [It is quite simple  { loop == 1 : (+ 5 / + 25) }]
            { loop == 1: This is not the best option. Try again. -> TopDetails }
...
= DontWorry
    ...
    * [Press him { loop == 1 : (+ 5 / + 30) }]
        ...
        ~ stolen_time = stolen_time + 5
        - - (Press)
        * * [Apoligize { loop == 1 : (+ 0 / + 25) }]
            { loop == 1: This is not the best option. Try again. -> Press }
        ...
        * * [Press further  { loop == 1 : (+ 5 / + 25) }]
            ...
            * * * [Show how much time Nino wastes]
                -> HowMuchTimeIsWasted
    * [Let him think { loop == 1 : (+ 0 / + 25) }]
        { loop == 1: This is not the best option. Try again. -> TopDontWorry }
...
= HowToSaveTime
    ...
    * [Start with simple things { loop == 1 : (+ 10 / END) }]
...
= SendFriendsHome
    ...
    * [Friends do not bring value]
        ...
        * * [Yes, you can  { loop == 1 : (+ 0 / + 25) }]
            ...
            * * * [See how easy it is  { loop == 1 : (+ 25 / END) }]
                "See how easy it is," you state matter-of-factly, <>
            * * * [Think of all the time you just saved { loop == 1 : (+ 25 / END) }]
            ...
            ~ stolen_time = stolen_time + 25
        * * [Then find some other way { loop == 1 : (+ 10 / END) }]
            { loop == 1: This is not the best option. Try again. -> UselessFriends }
